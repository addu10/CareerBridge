...
class ResumeAnalysisSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'user', 'user_id', 'resume_file', 'analysis_date',
                 'skills_match', 'improvement_suggestions', 'overall_score',
                 'keywords_found', 'missing_keywords')
        read_only_fields = ('analysis_date', 'skills_match', 'improvement_suggestions',
                           'overall_score', 'keywords_found', 'missing_keywords')
